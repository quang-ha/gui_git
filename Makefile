...
SRC = logsim.cc names.cc scanner.cc network.cc parser.cc monitor.cc devices.cc userint.cc gui.cc guitest.cc name_ex.cc

L_OBJECTS = logsim.o names.o scanner.o network.o parser.o monitor.o devices.o userint.o gui.o name_ex.o

G_OBJECTS = guitest.o names.o network.o monitor.o devices.o gui.o name_ex.o
...
guitest.o: guitest.h names.h devices.h network.h monitor.h gui.h name_ex.h
